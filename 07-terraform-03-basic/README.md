...
```
kosmos@centos:/git/devops-netology/terraform$ terraform workspace new prod
Created and switched to workspace "prod"!

kosmos@centos:/git/devops-netology/terraform$ terraform workspace new stage
...
Terraform will perform the following actions:
  ...
  # aws_instance.web-test["prod1"] will be created
  ...
  # aws_instance.web-test["prod2"] will be created
  + resource "aws_instance" "web-test" {
      + ami                                  = "ami-0fc272c9b2d204826"
      + arn                                  = (known after apply)
      + associate_public_ip_address          = (known after apply)
...
Changes to Outputs:
  ...
  + caller_arn     = [
      + "arn:aws:iam::876881443927:user/kosmos",
    ]
  + caller_user    = [
      + "AIDA4YKRU7RLR54TNEJCI",
    ]
  + private_ip_web = [
      + (known after apply),
      + (known after apply),
